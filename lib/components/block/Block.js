...
export default class Block extends Container {
  ...
  hoverImage(animIn = true) {
    if (animIn) {
      ...
      TweenMax.to(this.title, 0.5, {alpha: 1, delay: 0.2, ease: Power2.easeOut});
      TweenMax.to(this.title.position, 0.5, {y: this.title.position.__startY - 10, delay: 0.2, ease: Power2.easeOut});
      TweenMax.to(this.info, 0.5, {alpha: 1, delay: 0.4, ease: Power2.easeOut});
      TweenMax.to(this.info.position, 0.5, {y: this.info.position.__startY - 10, delay: 0.4, ease: Power2.easeOut});
    } else {
      ...
      TweenMax.to(this.title, 0.5, {alpha: 0, delay: 0.4, ease: Power2.easeOut});
      TweenMax.to(this.title.position, 0.5, {y: this.title.position.__startY, delay: 0.4, ease: Power2.easeOut});
      TweenMax.to(this.info, 0.5, {alpha: 0, delay: 0.2, ease: Power2.easeOut});
      TweenMax.to(this.info.position, 0.5, {y: this.info.position.__startY, delay: 0.2, ease: Power2.easeOut});
    }
  }
